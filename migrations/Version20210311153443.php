 ...
 */
final class Version20210311153443 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE manga (id INT AUTO_INCREMENT NOT NULL, serie_id INT DEFAULT NULL, nb_pages INT NOT NULL, prix_manga DOUBLE PRECISION NOT NULL, description_manga LONGTEXT NOT NULL, num_serie INT NOT NULL, date_parution DATE NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_765A9E03D94388BD (serie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE serie (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, editeur_id INT DEFAULT NULL, dessinateur_id INT DEFAULT NULL, scenariste_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, etat TINYINT(1) NOT NULL, INDEX IDX_AA3A9334BCF5E72D (categorie_id), INDEX IDX_AA3A93343375BD21 (editeur_id), INDEX IDX_AA3A9334EF0AD3BC (dessinateur_id), INDEX IDX_AA3A93341674CEC6 (scenariste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
